...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 libmspub-0.2.lib libwpd-stream-0.9.lib libwpd-0.9.lib /nologo /subsystem:console /machine:IX86 /out:"Release\bin\pub2raw.exe" /libpath:"Release\lib"
# ADD LINK32 libmspub-0.2.lib libwpd-stream-0.9.lib libwpd-0.9.lib /nologo /subsystem:console /machine:IX86 /out:"Release\bin\pub2raw.exe" /libpath:"Release\lib"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 libmspub-0.2.lib libwpd-stream-0.9.lib libwpd-0.9.lib /nologo /subsystem:console /debug /machine:IX86 /out:"Debug\bin\pub2raw.exe" /libpath:"Debug\lib"
# ADD LINK32 libmspub-0.2.lib libwpd-stream-0.9.lib libwpd-0.9.lib kernel32.lib /nologo /subsystem:console /debug /machine:IX86 /out:"Debug\bin\pub2raw.exe" /libpath:"Debug\lib"
# SUBTRACT LINK32 /nodefaultlib
