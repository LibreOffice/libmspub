...
libmspub::MSPUBSVGGenerator::~MSPUBSVGGenerator()
{
}
...
void libmspub::MSPUBSVGGenerator::endLayer()
{
  m_outputSink << "</svg:g>\n";
}

void libmspub::MSPUBSVGGenerator::drawRectangle(const ::WPXPropertyList &propList)
{
...
void libmspub::MSPUBSVGGenerator::drawEllipse(const WPXPropertyList &propList)
{
...
void libmspub::MSPUBSVGGenerator::drawPolyline(const ::WPXPropertyListVector &vertices)
{
  drawPolySomething(vertices, false);
}

void libmspub::MSPUBSVGGenerator::drawPolygon(const ::WPXPropertyListVector &vertices)
{
  drawPolySomething(vertices, true);
}

void libmspub::MSPUBSVGGenerator::drawPolySomething(const ::WPXPropertyListVector &vertices, bool isClosed)
{
  if(vertices.count() < 2)
    return;
...
void libmspub::MSPUBSVGGenerator::drawPath(const ::WPXPropertyListVector &path)
{
...
void libmspub::MSPUBSVGGenerator::drawGraphicObject(const ::WPXPropertyList &propList, const ::WPXBinaryData &binaryData)
{
...
void libmspub::MSPUBSVGGenerator::startTextObject(const ::WPXPropertyList &propList, const ::WPXPropertyListVector & /* path */)
{
...
void libmspub::MSPUBSVGGenerator::endTextObject()
{
  m_outputSink << "</svg:text>\n";
}

void libmspub::MSPUBSVGGenerator::startTextSpan(const ::WPXPropertyList &propList)
{
...
void libmspub::MSPUBSVGGenerator::endTextSpan()
{
  m_outputSink << "</svg:tspan>\n";
}

void libmspub::MSPUBSVGGenerator::insertText(const ::WPXString &str)
{
...
void libmspub::MSPUBSVGGenerator::writeStyle(bool /* isClosed */)
{
  m_outputSink << "style=\"";
