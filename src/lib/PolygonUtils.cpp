...
{
  { {5 CALCULATED_VALUE, 22 CALCULATED_VALUE}, {11 CALCULATED_VALUE, 23 CALCULATED_VALUE} }
};
...
{
  {0x12 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {0x14 CALCULATED_VALUE, 10800}, {0x13 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0x15 CALCULATED_VALUE, 10800}
};
...
{
  {0, 0}, {21600, 0}, {21600, 0 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 21600}, {0, 21600}, {0 CALCULATED_VALUE, 21600}, {3 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 9 CALCULATED_VALUE}, {10 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {21600, 0 CALCULATED_VALUE}
};
...
{
  {21600, 0 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 0}, {0, 10800}, {1 CALCULATED_VALUE, 21600}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 2 CALCULATED_VALUE}
};
...
{
  { {7 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {21600, 2 CALCULATED_VALUE} }
};
...
{
  {0, 1 CALCULATED_VALUE}, {10800, 0}, {21600, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {21600, 3 CALCULATED_VALUE}, {10800, 21600}, {0, 3 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}
};
...
{
  { {0 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 9 CALCULATED_VALUE} }
};
...
{
  {0, 10800}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {10800, 0}, {3 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {21600, 10800}, {5 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {10800, 21600}, {1 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 3 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0, 0}, {21600, 0}, {1 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {21600, 0}, {21600, 21600}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {21600, 21600}, {0, 21600}, {0 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {0, 21600}, {0, 0}, {0 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 2 CALCULATED_VALUE}
};
...
{
  { {0 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE} }
};
...
{
  {21600, 0}, {10800, 0}, {0, 3 CALCULATED_VALUE}, {0, 1 CALCULATED_VALUE}, {0, 2 CALCULATED_VALUE}, {0, 4 CALCULATED_VALUE}, {10800, 21600}, {21600, 21600}
};
...
{
  { {6350, 3 CALCULATED_VALUE}, {21600, 4 CALCULATED_VALUE} }
};
...
{
  {0, 0}, {10800, 0}, {21600, 3 CALCULATED_VALUE}, {21600, 1 CALCULATED_VALUE}, {21600, 2 CALCULATED_VALUE}, {21600, 4 CALCULATED_VALUE}, {10800, 21600}, {0, 21600}
};
...
{
  { {0, 3 CALCULATED_VALUE}, {15150, 4 CALCULATED_VALUE} }
};
...
{
  {21600, 0}, {16200, 0}, {10800, 0 CALCULATED_VALUE}, {10800, 1 CALCULATED_VALUE}, {10800, 2 CALCULATED_VALUE}, {10800, 3 CALCULATED_VALUE}, {5400, 4 CALCULATED_VALUE}, {0, 4 CALCULATED_VALUE}, {5400, 4 CALCULATED_VALUE}, {10800, 5 CALCULATED_VALUE}, {10800, 6 CALCULATED_VALUE}, {10800, 7 CALCULATED_VALUE}, {10800, 8 CALCULATED_VALUE}, {16200, 21600}, {21600, 21600}
};
...
{
  { {13800, 9 CALCULATED_VALUE}, {21600, 10 CALCULATED_VALUE} }
};
...
{
  {0, 0}, {5400, 0}, {10800, 0 CALCULATED_VALUE}, {10800, 1 CALCULATED_VALUE}, {10800, 2 CALCULATED_VALUE}, {10800, 3 CALCULATED_VALUE}, {16200, 4 CALCULATED_VALUE}, {21600, 4 CALCULATED_VALUE}, {16200, 4 CALCULATED_VALUE}, {10800, 5 CALCULATED_VALUE}, {10800, 6 CALCULATED_VALUE}, {10800, 7 CALCULATED_VALUE}, {10800, 8 CALCULATED_VALUE}, {5400, 21600}, {0, 21600}
};
...
{
  { {0, 9 CALCULATED_VALUE}, {7800, 10 CALCULATED_VALUE} }
};
...
{
  {0, 5 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 7 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 7 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 0}, {21600, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 21600}
};
...
{
  { {2 CALCULATED_VALUE, 7 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 1 CALCULATED_VALUE} }, { {7 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 1 CALCULATED_VALUE} }
};
...
{
  {10800, 10800}, {10800, 10800}, {0, 360}, {7305, 7515}, {1165, 1165}, {0, 360}, {14295, 7515}, {1165, 1165}, {0, 360}, {4870, 1 CALCULATED_VALUE}, {8680, 2 CALCULATED_VALUE}, {12920, 2 CALCULATED_VALUE}, {16730, 1 CALCULATED_VALUE}
};
...
{
  {1 CALCULATED_VALUE, 21600}, {0, 11 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 0}, {2 CALCULATED_VALUE, 0}, {21600, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 21600}, {6 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 9 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 21600}, {0, 11 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {9 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 0}, {6 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0 CALCULATED_VALUE}
};
...
{
  { {0 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 12 CALCULATED_VALUE} }
};
...
{
  {0, 4 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0}, {21600, 1 CALCULATED_VALUE}, {21600, 13 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 21600}, {0, 11 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {9 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 6 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 9 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0}, {21600, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 6 CALCULATED_VALUE}, {0, 4 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 11 CALCULATED_VALUE}
};
...
{
  {0x03 CALCULATED_VALUE, 0x03 CALCULATED_VALUE}, {0x14 CALCULATED_VALUE, 0x14 CALCULATED_VALUE}, {0x13 CALCULATED_VALUE, 0x12 CALCULATED_VALUE}, {0x11 CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0, 0}, {21600, 21600}, {0x09 CALCULATED_VALUE, 0x08 CALCULATED_VALUE}, {0x0B CALCULATED_VALUE, 0x0A CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 0x17 CALCULATED_VALUE}, {0x2F CALCULATED_VALUE, 0x2E CALCULATED_VALUE}, {0x1D CALCULATED_VALUE, 0x1C CALCULATED_VALUE}
};
...
{
  {0, 0}, {23 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 0}, {0, 4 CALCULATED_VALUE}, {0, 15 CALCULATED_VALUE}, {23 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0, 7 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 13 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 14 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {0, 0}, {23 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {26 CALCULATED_VALUE, 17 CALCULATED_VALUE}, {0, 15 CALCULATED_VALUE}, {23 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {26 CALCULATED_VALUE, 17 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 15 CALCULATED_VALUE}, {0, 0}, {23 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 0}, {0, 4 CALCULATED_VALUE}, {0, 0}, {23 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {0, 4 CALCULATED_VALUE}, {26 CALCULATED_VALUE, 17 CALCULATED_VALUE}, {0, 15 CALCULATED_VALUE}, {23 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {26 CALCULATED_VALUE, 17 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 15 CALCULATED_VALUE}
};
...
{
  { {47 CALCULATED_VALUE, 45 CALCULATED_VALUE}, {48 CALCULATED_VALUE, 46 CALCULATED_VALUE} }
};
...
{
  {0, 17 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 14 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 16 CALCULATED_VALUE}
};
...
{
  {22 CALCULATED_VALUE, 0}, {21 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {0, 0}, {21 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 14 CALCULATED_VALUE}, {21 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {21 CALCULATED_VALUE, 7 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 13 CALCULATED_VALUE}, {0, 8 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 0}, {21 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {24 CALCULATED_VALUE, 16 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 14 CALCULATED_VALUE}, {21 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {24 CALCULATED_VALUE, 16 CALCULATED_VALUE}, {0, 14 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 0}, {21 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {0, 0}, {21 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 14 CALCULATED_VALUE}, {21 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {21 CALCULATED_VALUE, 7 CALCULATED_VALUE}, {24 CALCULATED_VALUE, 16 CALCULATED_VALUE}, {22 CALCULATED_VALUE, 14 CALCULATED_VALUE}, {21 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {24 CALCULATED_VALUE, 16 CALCULATED_VALUE}, {0, 14 CALCULATED_VALUE}
};
...
{
  { {43 CALCULATED_VALUE, 41 CALCULATED_VALUE}, {44 CALCULATED_VALUE, 42 CALCULATED_VALUE} }
};
...
{
  {0, 15 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {0, 8 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 13 CALCULATED_VALUE}, {21 CALCULATED_VALUE, 16 CALCULATED_VALUE}
};


const Vertex CURVED_DOWN_ARROW_VERTICES[] =
{
  {0, 0}, {3 CALCULATED_VALUE, 23 CALCULATED_VALUE}, {0, 22 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 0}, {15 CALCULATED_VALUE, 0}, {1 CALCULATED_VALUE, 23 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 0}, {13 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {14 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 22 CALCULATED_VALUE}, {12 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {0, 0}, {3 CALCULATED_VALUE, 23 CALCULATED_VALUE}, {11 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {17 CALCULATED_VALUE, 26 CALCULATED_VALUE}, {15 CALCULATED_VALUE, 0}, {1 CALCULATED_VALUE, 23 CALCULATED_VALUE}, {17 CALCULATED_VALUE, 26 CALCULATED_VALUE}, {15 CALCULATED_VALUE, 22 CALCULATED_VALUE}, {0, 0}, {3 CALCULATED_VALUE, 23 CALCULATED_VALUE}, {0, 22 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 0}, {0, 0}, {3 CALCULATED_VALUE, 23 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 0}, {17 CALCULATED_VALUE, 26 CALCULATED_VALUE}, {15 CALCULATED_VALUE, 0}, {1 CALCULATED_VALUE, 23 CALCULATED_VALUE}, {17 CALCULATED_VALUE, 26 CALCULATED_VALUE}, {15 CALCULATED_VALUE, 22 CALCULATED_VALUE}
};
...
{
  { {45 CALCULATED_VALUE, 47 CALCULATED_VALUE}, {46 CALCULATED_VALUE, 48 CALCULATED_VALUE} }
};
...
{
  {17 CALCULATED_VALUE, 0}, {16 CALCULATED_VALUE, 22 CALCULATED_VALUE}, {12 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 22 CALCULATED_VALUE}, {14 CALCULATED_VALUE, 2 CALCULATED_VALUE}
};
...
{
  {0, 22 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {0, 0}, {4 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {14 CALCULATED_VALUE, 22 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {12 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {13 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 0}, {11 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {0, 22 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {10 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {16 CALCULATED_VALUE, 24 CALCULATED_VALUE}, {14 CALCULATED_VALUE, 22 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {16 CALCULATED_VALUE, 24 CALCULATED_VALUE}, {14 CALCULATED_VALUE, 0}, {0, 22 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {0, 0}, {4 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {14 CALCULATED_VALUE, 22 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {16 CALCULATED_VALUE, 24 CALCULATED_VALUE}, {14 CALCULATED_VALUE, 22 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {16 CALCULATED_VALUE, 24 CALCULATED_VALUE}, {14 CALCULATED_VALUE, 0}
};
...
{
  { {41 CALCULATED_VALUE, 43 CALCULATED_VALUE}, {42 CALCULATED_VALUE, 44 CALCULATED_VALUE} }
};
...
{
  {8 CALCULATED_VALUE, 0}, {11 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {15 CALCULATED_VALUE, 0}, {16 CALCULATED_VALUE, 21 CALCULATED_VALUE}, {13 CALCULATED_VALUE, 2 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 21600}, {4 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {6 CALCULATED_VALUE, 6 CALCULATED_VALUE}, {9 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {11 CALCULATED_VALUE, 10 CALCULATED_VALUE}
};
...
{
  {0, 1 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 0}, {21600, 10800}, {0 CALCULATED_VALUE, 21600}, {0 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {0, 2 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 10800}, {0, 1 CALCULATED_VALUE}
};
...
{
  {3375, 0 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 0}, {21600, 10800}, {1 CALCULATED_VALUE, 21600}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {3375, 2 CALCULATED_VALUE}, {0, 0 CALCULATED_VALUE}, {675, 0 CALCULATED_VALUE}, {675, 2 CALCULATED_VALUE}, {0, 2 CALCULATED_VALUE}, {1350, 0 CALCULATED_VALUE}, {2700, 0 CALCULATED_VALUE}, {2700, 2 CALCULATED_VALUE}, {1350, 2 CALCULATED_VALUE}
};
...
{
  { {3375, 0 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 2 CALCULATED_VALUE} }
};
...
{
  { {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE} }
};
...
{
  {0, 21600}, {0, 12160}, {12427, 1 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 0}, {21600, 6079}, {0 CALCULATED_VALUE, 12158}, {0 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {12427, 2 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 12160}, {4 CALCULATED_VALUE, 21600}
};
...
{
  {0, 8 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 0}, {21600, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 21600}, {0, 21600}
};
...
{
  {0 CALCULATED_VALUE, 0}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0, 1 CALCULATED_VALUE}, {10800, 21600}, {21600, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0}
};
...
{
  { {0 CALCULATED_VALUE, 0}, {2 CALCULATED_VALUE, 5 CALCULATED_VALUE} }
};
...
{
  {0 CALCULATED_VALUE, 21600}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0, 1 CALCULATED_VALUE}, {10800, 0}, {21600, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 21600}
};
...
{
  { {0 CALCULATED_VALUE, 7 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 21600} }
};
...
{
  {0, 10800}, {0 CALCULATED_VALUE, 0}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0}, {21600, 10800}, {2 CALCULATED_VALUE, 21600}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 21600}
};
...
{
  { {5 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {6 CALCULATED_VALUE, 3 CALCULATED_VALUE} }
};
...
{
  {0x05 CALCULATED_VALUE, 0x06 CALCULATED_VALUE}, {0x07 CALCULATED_VALUE, 0x08 CALCULATED_VALUE}, {0x09 CALCULATED_VALUE, 0x0a CALCULATED_VALUE}, {0x0b CALCULATED_VALUE, 0x0c CALCULATED_VALUE}, {0x0d CALCULATED_VALUE, 0x0e CALCULATED_VALUE}, {0x0f CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0x11 CALCULATED_VALUE, 0x12 CALCULATED_VALUE}, {0x13 CALCULATED_VALUE, 0x14 CALCULATED_VALUE}, {0x15 CALCULATED_VALUE, 0x16 CALCULATED_VALUE}, {0x17 CALCULATED_VALUE, 0x18 CALCULATED_VALUE}, {0x19 CALCULATED_VALUE, 0x1a CALCULATED_VALUE}, {0x1b CALCULATED_VALUE, 0x1c CALCULATED_VALUE}, {0x1d CALCULATED_VALUE, 0x1e CALCULATED_VALUE}, {0x1f CALCULATED_VALUE, 0x20 CALCULATED_VALUE}, {0x21 CALCULATED_VALUE, 0x22 CALCULATED_VALUE}, {0x23 CALCULATED_VALUE, 0x24 CALCULATED_VALUE}, {0x25 CALCULATED_VALUE, 0x26 CALCULATED_VALUE}, {0x27 CALCULATED_VALUE, 0x28 CALCULATED_VALUE}, {0x29 CALCULATED_VALUE, 0x2a CALCULATED_VALUE}, {0x2b CALCULATED_VALUE, 0x2c CALCULATED_VALUE}, {0x2d CALCULATED_VALUE, 0x2e CALCULATED_VALUE}, {0x2f CALCULATED_VALUE, 0x30 CALCULATED_VALUE}, {0x31 CALCULATED_VALUE, 0x32 CALCULATED_VALUE}, {0x33 CALCULATED_VALUE, 0x34 CALCULATED_VALUE}, {0x35 CALCULATED_VALUE, 0x36 CALCULATED_VALUE}, {0x37 CALCULATED_VALUE, 0x38 CALCULATED_VALUE}, {0x39 CALCULATED_VALUE, 0x3a CALCULATED_VALUE}, {0x3b CALCULATED_VALUE, 0x3c CALCULATED_VALUE}, {0x3d CALCULATED_VALUE, 0x3e CALCULATED_VALUE}, {0x3f CALCULATED_VALUE, 0x40 CALCULATED_VALUE}, {0x41 CALCULATED_VALUE, 0x42 CALCULATED_VALUE}, {0x43 CALCULATED_VALUE, 0x44 CALCULATED_VALUE}, {0x05 CALCULATED_VALUE, 0x06 CALCULATED_VALUE}
};
...
{
  {10800, 10800}, {10800, 10800}, {0, 360}, {0 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {9 CALCULATED_VALUE, 0xa CALCULATED_VALUE}, {0xb CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0xd CALCULATED_VALUE, 0xe CALCULATED_VALUE}, {0xf CALCULATED_VALUE, 0x10 CALCULATED_VALUE}
};
...
{
  { {0 CALCULATED_VALUE, 0}, {19 CALCULATED_VALUE, 1 CALCULATED_VALUE} }
};
...
{
  {0, 0}, {0 CALCULATED_VALUE, 0}, {21600, 10800}, {0 CALCULATED_VALUE, 21600}, {0, 21600}, {1 CALCULATED_VALUE, 10800}
};
...
{
  {0, 0}, {3 CALCULATED_VALUE, 0}, {4 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {6 CALCULATED_VALUE, 0}, {21600, 0}, {18 CALCULATED_VALUE, 14 CALCULATED_VALUE}, {21600, 15 CALCULATED_VALUE}, {9 CALCULATED_VALUE, 15 CALCULATED_VALUE}, {9 CALCULATED_VALUE, 16 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 21600}, {1 CALCULATED_VALUE, 21600}, {0 CALCULATED_VALUE, 16 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 15 CALCULATED_VALUE}, {0, 15 CALCULATED_VALUE}, {2700, 14 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 13 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {6 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {9 CALCULATED_VALUE, 13 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 13 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 15 CALCULATED_VALUE}, {9 CALCULATED_VALUE, 13 CALCULATED_VALUE}, {9 CALCULATED_VALUE, 15 CALCULATED_VALUE}
};
...
{
  { {0 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {9 CALCULATED_VALUE, 21600} }
};
...
{
  {17 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {2700, 14 CALCULATED_VALUE}, {17 CALCULATED_VALUE, 21600}, {18 CALCULATED_VALUE, 14 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 5 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {6 CALCULATED_VALUE, 7 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21 CALCULATED_VALUE, 0}, {0 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 14 CALCULATED_VALUE}, {6 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 18 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 16 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 20 CALCULATED_VALUE}, {10 CALCULATED_VALUE, 21600}, {21600, 21600}
};
...
{
  {0, 0}, {1 CALCULATED_VALUE, 0}, {0 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 9 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {21600, 14 CALCULATED_VALUE}, {21600, 21600}
};
...
{
  {0, 0}, {1 CALCULATED_VALUE, 0}, {0 CALCULATED_VALUE, 5400}, {0 CALCULATED_VALUE, 10800}, {0 CALCULATED_VALUE, 16200}, {3 CALCULATED_VALUE, 21600}, {21600, 21600}
};
...
{
  {0, 0}, {0 CALCULATED_VALUE, 0}, {0 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 21600}, {21600, 21600}
};
...
{
  {0, 0}, {0 CALCULATED_VALUE, 0}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {21600, 1 CALCULATED_VALUE}, {21600, 21600}
};
...
{
  {0, 0}, {0 CALCULATED_VALUE, 0}, {0 CALCULATED_VALUE, 21600}, {21600, 21600}
};
...
{
  {10800, 10800}, {10800, 10800}, {0, 360}, {10800, 10800}, {1 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0, 360}
};
...
{
  {44, 0}, {20, 0}, {0, 2 CALCULATED_VALUE}, {0, 0 CALCULATED_VALUE}, {0, 3 CALCULATED_VALUE}, {0, 4 CALCULATED_VALUE}, {20, 21600}, {44, 21600}, {68, 21600}, {88, 4 CALCULATED_VALUE}, {88, 3 CALCULATED_VALUE}, {88, 0 CALCULATED_VALUE}, {88, 2 CALCULATED_VALUE}, {68, 0}, {44, 0}, {44, 0}, {20, 0}, {0, 2 CALCULATED_VALUE}, {0, 0 CALCULATED_VALUE}, {0, 5 CALCULATED_VALUE}, {20, 6 CALCULATED_VALUE}, {44, 6 CALCULATED_VALUE}, {68, 6 CALCULATED_VALUE}, {88, 5 CALCULATED_VALUE}, {88, 0 CALCULATED_VALUE}, {88, 2 CALCULATED_VALUE}, {68, 0}, {44, 0}
};
...
{
  { {0, 6 CALCULATED_VALUE}, {88, 3 CALCULATED_VALUE} }
};
...
{
  {44, 6 CALCULATED_VALUE}, {44, 0}, {0, 10800}, {44, 21600}, {88, 10800}
};
...
{
  {0 CALCULATED_VALUE, 0}, {0, 1 CALCULATED_VALUE}, {0, 2 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 21600}, {3 CALCULATED_VALUE, 21600}, {21600, 2 CALCULATED_VALUE}, {21600, 1 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 0}
};
...
{
  { {0xC CALCULATED_VALUE, 0xD CALCULATED_VALUE}, {0xE CALCULATED_VALUE, 0xF CALCULATED_VALUE} }
};
...
{
  {3590, 0}, {0, 3590}, {0, 14460}, {3590, 18050}, {40 CALCULATED_VALUE, 21600}, {5420, 18050}, {18010, 18050}, {21600, 14460}, {21600, 3590}, {18010, 0}
};
...
{
  {0, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {10800, 10800}, {0, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 5 CALCULATED_VALUE}
};
...
{
  {0, 12 CALCULATED_VALUE}, {0, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0}, {11 CALCULATED_VALUE, 0}, {11 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {0, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 0}, {11 CALCULATED_VALUE, 0}, {4 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {11 CALCULATED_VALUE, 0}, {11 CALCULATED_VALUE, 3 CALCULATED_VALUE}
};
...
{
  { {0, 1 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 12 CALCULATED_VALUE} }
};
...
{
  {7 CALCULATED_VALUE, 0}, {6 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0, 10 CALCULATED_VALUE}, {6 CALCULATED_VALUE, 21600}, {4 CALCULATED_VALUE, 10 CALCULATED_VALUE}, {21600, 9 CALCULATED_VALUE}
};
...
{
  {0, 0}, {0 CALCULATED_VALUE, 0}, {21600, 10800}, {0 CALCULATED_VALUE, 21600}, {0, 21600}
};
...
{
  {0, 0 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 0 CALCULATED_VALUE }, {1 CALCULATED_VALUE , 0}, {21600, 10800}, {1 CALCULATED_VALUE , 21600}, {1 CALCULATED_VALUE , 2 CALCULATED_VALUE }, {0, 2 CALCULATED_VALUE }
};
...
{
  { {0, 0 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 2 CALCULATED_VALUE} }
};
...
{
  {0 CALCULATED_VALUE, 0}, {2 CALCULATED_VALUE, 0}, {21600, 1 CALCULATED_VALUE}, {21600, 3 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 21600}, {0 CALCULATED_VALUE, 21600}, {0, 3 CALCULATED_VALUE}, {0, 1 CALCULATED_VALUE}
};
...
{
  { {5 CALCULATED_VALUE, 6 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 8 CALCULATED_VALUE} }
};
...
{
  {7 CALCULATED_VALUE, 0},
  {0, 8 CALCULATED_VALUE},
  {0, 9 CALCULATED_VALUE},
  {7 CALCULATED_VALUE, 21600},
  {10 CALCULATED_VALUE, 21600},
  {21600, 9 CALCULATED_VALUE},
  {21600, 8 CALCULATED_VALUE},
  {10 CALCULATED_VALUE, 0}
};
...
{
  { {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 6 CALCULATED_VALUE} }
};
...
{
  {1 CALCULATED_VALUE, 0}, {2 CALCULATED_VALUE, 0}, {2 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {21600, 1 CALCULATED_VALUE}, {21600, 3 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 21600}, {1 CALCULATED_VALUE, 21600}, {1 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {0, 3 CALCULATED_VALUE}, {0, 1 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 0}
};
...
{
  { {1 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE} }
};
...
{
  {0, 0}, {21600, 0}, {0 CALCULATED_VALUE, 21600}, {1 CALCULATED_VALUE, 21600}
};
...
{
  { {3 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 4 CALCULATED_VALUE} }
};
...
{
  {6 CALCULATED_VALUE, 10800}, {10800, 21600}, {5 CALCULATED_VALUE, 10800}, {10800, 0}
};
...
{
  {0, 10800}, {4 CALCULATED_VALUE, 4 CALCULATED_VALUE},
  {10800, 0}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE},
  {21600, 10800}, {3 CALCULATED_VALUE, 3 CALCULATED_VALUE},
  {10800, 21600}, {4 CALCULATED_VALUE, 3 CALCULATED_VALUE},
  {0, 10800}
};
...
{
  { {4 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 3 CALCULATED_VALUE} }
};
...
{
  {0 CALCULATED_VALUE, 0}, {21600, 21600}, {0, 21600}
};
...
{
  { {1 CALCULATED_VALUE, 10800}, {2 CALCULATED_VALUE, 18000} },
  { {3 CALCULATED_VALUE, 7200}, {4 CALCULATED_VALUE, 21600} }
};

const Vertex ISOCELES_TRIANGLE_GLUE_POINTS[] =
{
  {10800, 0}, {1 CALCULATED_VALUE, 10800},
  {0, 21600}, {10800, 21600},
  {21600, 21600}, {7 CALCULATED_VALUE, 10800}
};
...
{
  {0 CALCULATED_VALUE, 0}, {21600, 0}, {1 CALCULATED_VALUE, 21600}, {0, 21600}
};
...
{
  {6 CALCULATED_VALUE, 0}, {10800, 8 CALCULATED_VALUE}, {11 CALCULATED_VALUE, 10800}, {9 CALCULATED_VALUE, 21600}, {10800, 10 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 10800}
};
...
{
  {0 CALCULATED_VALUE, 0}, {1 CALCULATED_VALUE, 0}, {21600, 10800}, {1 CALCULATED_VALUE, 21600}, {0 CALCULATED_VALUE, 21600}, {0, 10800}
};
...
{
  {3 CALCULATED_VALUE, 0}, {5 CALCULATED_VALUE, 0}, {6 CALCULATED_VALUE, 21600}, {7 CALCULATED_VALUE, 21600}
};
...
{
  {0, 0 CALCULATED_VALUE}, {7200, 0}, {14400, 0}, {21600, 0 CALCULATED_VALUE}, {0, 1 CALCULATED_VALUE}, {7200, 21600}, {14400, 21600}, {21600, 1 CALCULATED_VALUE}
};
...
{
  {0, 0 CALCULATED_VALUE}, {10800, 0}, {21600, 0 CALCULATED_VALUE}, {0, 21600}, {21600, 21600}
};
...
{
  {0, 0}, {21600, 0}, {0, 0 CALCULATED_VALUE}, {10800, 21600}, {21600, 0 CALCULATED_VALUE}
};
...
{
  {0, 0 CALCULATED_VALUE}, {10800, 0}, {21600, 0 CALCULATED_VALUE}, {0, 21600}, {10800, 1 CALCULATED_VALUE}, {21600, 21600}
};
...
{
  {0, 0}, {10800, 1 CALCULATED_VALUE}, {21600, 0}, {0, 0 CALCULATED_VALUE}, {10800, 21600}, {21600, 0 CALCULATED_VALUE}
};
...
{
  {10800, 0 CALCULATED_VALUE}, {10800, 0 CALCULATED_VALUE}, {180, 359}, {10800, 1 CALCULATED_VALUE}, {10800, 0 CALCULATED_VALUE}, {180, 359}
};
...
{
  {0, 0}, {21600, 21600}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 3 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 21600}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {11 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 9 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 9 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 21600}, {4 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 21600}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 4 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 21600}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {0, 10800}, {21600, 10800}, {0, 0}, {21600, 21600}, {2 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 5 CALCULATED_VALUE}
};
...
{
  {5 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {11 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 9 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 9 CALCULATED_VALUE}, {0, 0}, {21600, 21600}, {4 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 21600}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {11 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 9 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 0xa CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 21600}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {6 CALCULATED_VALUE, 6 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 7 CALCULATED_VALUE}, {10 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {12 CALCULATED_VALUE, 11 CALCULATED_VALUE}, {0x16 CALCULATED_VALUE, 16 CALCULATED_VALUE}, {0x15 CALCULATED_VALUE, 16 CALCULATED_VALUE}, {0x16 CALCULATED_VALUE, 15 CALCULATED_VALUE}, {0x15 CALCULATED_VALUE, 15 CALCULATED_VALUE}, {6 CALCULATED_VALUE, 6 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 7 CALCULATED_VALUE}, {10 CALCULATED_VALUE, 13 CALCULATED_VALUE}, {12 CALCULATED_VALUE, 13 CALCULATED_VALUE}, {0, 0}, {21600, 21600}, {2 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 5 CALCULATED_VALUE}
};
...
{
  {0, 0 CALCULATED_VALUE}, {4900, 1 CALCULATED_VALUE /*12170->0 14250 ->0*/}, {11640, 2 CALCULATED_VALUE /*12170->0 12800 ->0*/}, {21600, 0}, {0, 4 CALCULATED_VALUE /*12170->0 17220 ->21600*/}, {3700, 21600}, {8500, 21600}, {10100, 21600}, {14110, 21600}, {15910, 21600}, {21600, 4 CALCULATED_VALUE /*12170->0 17220 ->21600*/}
};
...
{
  {0, 0}, {9960, 2 CALCULATED_VALUE}, {16700, 1 CALCULATED_VALUE}, {21600, 0 CALCULATED_VALUE}, {0, 4 CALCULATED_VALUE}, {5690, 21600}, {7490, 21600}, {11500, 21600}, {13100, 21600}, {17900, 21600}, {21600, 4 CALCULATED_VALUE}
};
...
{
  {0, 2 CALCULATED_VALUE}, {21600, 0}, {0, 21600}, {21600, 0 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 2 CALCULATED_VALUE}, {0, 0 CALCULATED_VALUE}, {21600, 21600}
};
...
{
  {0, 0 CALCULATED_VALUE}, {4100, 1 CALCULATED_VALUE}, {7300, 0}, {10800, 0}, {14300, 0}, {17500, 1 CALCULATED_VALUE}, {21600, 0 CALCULATED_VALUE}, {0, 2 CALCULATED_VALUE}, {4100, 3 CALCULATED_VALUE}, {7300, 21600}, {10800, 21600}, {14300, 21600}, {17500, 3 CALCULATED_VALUE}, {21600, 2 CALCULATED_VALUE}
};
...
{
  {0, 0}, {3500, 1 CALCULATED_VALUE}, {7100, 0 CALCULATED_VALUE}, {10800, 0 CALCULATED_VALUE}, {14500, 0 CALCULATED_VALUE}, {18100, 1 CALCULATED_VALUE}, {21600, 0}, {0, 21600}, {3500, 3 CALCULATED_VALUE}, {7100, 2 CALCULATED_VALUE}, {10800, 2 CALCULATED_VALUE}, {14500, 2 CALCULATED_VALUE}, {18100, 3 CALCULATED_VALUE}, {21600, 21600}
};
...
{
  {0, 0}, {21600, 0}, {0, 0 CALCULATED_VALUE}, {3500, 3 CALCULATED_VALUE}, {7300, 21600}, {10800, 21600}, {14300, 21600}, {18100, 3 CALCULATED_VALUE}, {21600, 0 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {0, 21600}, {2900, 3 CALCULATED_VALUE}, {7200, 0 CALCULATED_VALUE}, {10800, 0 CALCULATED_VALUE}, {14400, 0 CALCULATED_VALUE}, {18700, 3 CALCULATED_VALUE}, {21600, 21600}
};
...
{
  {0, 0 CALCULATED_VALUE}, {3500, 1 CALCULATED_VALUE}, {7300, 0}, {10800, 0}, {14300, 0}, {18100, 1 CALCULATED_VALUE}, {21600, 0 CALCULATED_VALUE}, {0, 21600}, {21600, 21600}
};
...
{
  {0, 0}, {2900, 1 CALCULATED_VALUE}, {7200, 0 CALCULATED_VALUE}, {10800, 0 CALCULATED_VALUE}, {14400, 0 CALCULATED_VALUE}, {18700, 1 CALCULATED_VALUE}, {21600, 0}, {0, 21600}, {21600, 21600}
};
...
{
  {0, 0}, {21600, 0}, {0, 10100}, {3300, 3 CALCULATED_VALUE}, {7100, 5 CALCULATED_VALUE}, {10800, 5 CALCULATED_VALUE}, {14500, 5 CALCULATED_VALUE}, {18300, 3 CALCULATED_VALUE}, {21600, 10100}, {0, 11500}, {3300, 4 CALCULATED_VALUE}, {7100, 6 CALCULATED_VALUE}, {10800, 6 CALCULATED_VALUE}, {14500, 6 CALCULATED_VALUE}, {18300, 4 CALCULATED_VALUE}, {21600, 11500}, {0, 21600}, {21600, 21600}
};
...
{
  {0, 0}, {21600, 0}, {0, 6600}, {3600, 3 CALCULATED_VALUE}, {7250, 4 CALCULATED_VALUE}, {10800, 4 CALCULATED_VALUE}, {14350, 4 CALCULATED_VALUE}, {18000, 3 CALCULATED_VALUE}, {21600, 6600}, {0, 7500}, {3600, 5 CALCULATED_VALUE}, {7250, 6 CALCULATED_VALUE}, {10800, 6 CALCULATED_VALUE}, {14350, 6 CALCULATED_VALUE}, {18000, 5 CALCULATED_VALUE}, {21600, 7500}, {0, 14100}, {3600, 9 CALCULATED_VALUE}, {7250, 10 CALCULATED_VALUE}, {10800, 10 CALCULATED_VALUE}, {14350, 10 CALCULATED_VALUE}, {18000, 9 CALCULATED_VALUE}, {21600, 14100}, {0, 15000}, {3600, 7 CALCULATED_VALUE}, {7250, 8 CALCULATED_VALUE}, {10800, 8 CALCULATED_VALUE}, {14350, 8 CALCULATED_VALUE}, {18000, 7 CALCULATED_VALUE}, {21600, 15000}, {0, 21600}, {21600, 21600}
};
...
{
  {0, 0}, {21600, 0 CALCULATED_VALUE}, {0, 21600}, {21600, 1 CALCULATED_VALUE}
};
...
{
  {0, 0 CALCULATED_VALUE}, {21600, 0}, {0, 1 CALCULATED_VALUE}, {21600, 21600}
};
...
{
  {0 CALCULATED_VALUE, 0}, {1 CALCULATED_VALUE, 0}, {0, 21600}, {21600, 21600}
};
...
{
  {0, 0 CALCULATED_VALUE}, {21600, 0}, {0, 21600}, {21600, 1 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 1 CALCULATED_VALUE}, {0, 0 CALCULATED_VALUE}, {21600, 21600}
};
...
{
  {0, 1 CALCULATED_VALUE}, {900, 0}, {7100, 0}, {10800, 0}, {14500, 0}, {20700, 0}, {21600, 1 CALCULATED_VALUE}, {0, 21600}, {900, 4 CALCULATED_VALUE}, {7100, 0 CALCULATED_VALUE}, {10800, 0 CALCULATED_VALUE}, {14500, 0 CALCULATED_VALUE}, {20700, 4 CALCULATED_VALUE}, {21600, 21600}
};
...
{
  {0, 0}, {900, 2 CALCULATED_VALUE}, {7100, 0 CALCULATED_VALUE}, {10800, 0 CALCULATED_VALUE}, {14500, 0 CALCULATED_VALUE}, {20700, 2 CALCULATED_VALUE}, {21600, 0}, {0, 1 CALCULATED_VALUE}, {900, 21600}, {7100, 21600}, {10800, 21600}, {14500, 21600}, {20700, 21600}, {21600, 1 CALCULATED_VALUE}
};
...
{
  {0, 2 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 0}, {1 CALCULATED_VALUE, 0}, {21600, 2 CALCULATED_VALUE}, {21600, 3 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 21600}, {0 CALCULATED_VALUE, 21600}, {0, 3 CALCULATED_VALUE}
};
...
{
  { {4 CALCULATED_VALUE, 6 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 7 CALCULATED_VALUE} }
};
...
{
  {10800, 0}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {21600, 10800}, {5 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {5 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 3 CALCULATED_VALUE}, {0, 10800}, {2 CALCULATED_VALUE, 0 CALCULATED_VALUE}, {2 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 2 CALCULATED_VALUE}
};
...
{
  {0, 10800}, {4 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 9 CALCULATED_VALUE}, {0x0a CALCULATED_VALUE, 0x0b CALCULATED_VALUE}, {0x0c CALCULATED_VALUE, 0x0d CALCULATED_VALUE}, {0x0e CALCULATED_VALUE, 0x0f CALCULATED_VALUE}, {0x10 CALCULATED_VALUE, 0x11 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x13 CALCULATED_VALUE}, {0x14 CALCULATED_VALUE, 0x15 CALCULATED_VALUE}, {0x16 CALCULATED_VALUE, 0x17 CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 0x19 CALCULATED_VALUE}, {0x1a CALCULATED_VALUE, 0x1b CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 0x1d CALCULATED_VALUE}, {0x1e CALCULATED_VALUE, 0x1f CALCULATED_VALUE}, {0x20 CALCULATED_VALUE, 0x21 CALCULATED_VALUE}, {0x22 CALCULATED_VALUE, 0x23 CALCULATED_VALUE}, {0x24 CALCULATED_VALUE, 0x25 CALCULATED_VALUE}, {0x26 CALCULATED_VALUE, 0x27 CALCULATED_VALUE}, {0x28 CALCULATED_VALUE, 0x29 CALCULATED_VALUE}, {0x2a CALCULATED_VALUE, 0x2b CALCULATED_VALUE}, {0x2c CALCULATED_VALUE, 0x2d CALCULATED_VALUE}, {0x2e CALCULATED_VALUE, 0x2f CALCULATED_VALUE}, {0x30 CALCULATED_VALUE, 0x31 CALCULATED_VALUE}, {0x32 CALCULATED_VALUE, 0x33 CALCULATED_VALUE}, {10800, 10800}, {0x36 CALCULATED_VALUE, 0x36 CALCULATED_VALUE}, {0, 360}
};
...
{
  { {0x34 CALCULATED_VALUE, 0x34 CALCULATED_VALUE}, {0x35 CALCULATED_VALUE, 0x35 CALCULATED_VALUE} }
};
...
{
  {21600, 0}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 5080}, {0 CALCULATED_VALUE, 10800}, {0 CALCULATED_VALUE, 16520}, {3 CALCULATED_VALUE, 5 CALCULATED_VALUE}, {21600, 21600}, {9740, 21600}, {0, 16730}, {0, 10800}, {0, 4870}, {9740, 0}, {21600, 0}
};
...
{
  { {9 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 10 CALCULATED_VALUE} }
};
...
{
  {21600, 0}, {0, 10800}, {21600, 21600}, {0 CALCULATED_VALUE, 10800}
};
...
{
  { {8 CALCULATED_VALUE, 9 CALCULATED_VALUE}, {10 CALCULATED_VALUE, 11 CALCULATED_VALUE} }
};
...
{
  {4 CALCULATED_VALUE, 0}, {0 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 6 CALCULATED_VALUE}, {0, 10800}, {0 CALCULATED_VALUE, 7 CALCULATED_VALUE}, {0 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {4 CALCULATED_VALUE, 21600}, {8 CALCULATED_VALUE, 21600}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 7 CALCULATED_VALUE}, {21600, 10800}, {3 CALCULATED_VALUE, 6 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 1 CALCULATED_VALUE}, {8 CALCULATED_VALUE, 0}
};
...
{
  { {11 CALCULATED_VALUE, 12 CALCULATED_VALUE}, {13 CALCULATED_VALUE, 14 CALCULATED_VALUE} }
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0, 0}, {21600, 0}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 21600}, {0, 21600}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0, 21600}, {0, 0}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 0xa CALCULATED_VALUE}, {0xc CALCULATED_VALUE, 0xe CALCULATED_VALUE}, {0xc CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x14 CALCULATED_VALUE}, {0x16 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 0x1a CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 0x1a CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x1e CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0xc CALCULATED_VALUE, 0xe CALCULATED_VALUE}, {0xc CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x14 CALCULATED_VALUE}, {0x20 CALCULATED_VALUE, 0x24 CALCULATED_VALUE}, {0x22 CALCULATED_VALUE, 0x24 CALCULATED_VALUE}, {0x22 CALCULATED_VALUE, 0x1a CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 0x1a CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 0x1a CALCULATED_VALUE}, {0x20 CALCULATED_VALUE, 0x1a CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0, 0}, {21600, 0}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 21600}, {0, 21600}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0, 21600}, {0, 0}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0x3e CALCULATED_VALUE}, {7 CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0x3e CALCULATED_VALUE}, {7 CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x14 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x16 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x18 CALCULATED_VALUE}, {0x1a CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x1e CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x20 CALCULATED_VALUE, 0x22 CALCULATED_VALUE}, {0x20 CALCULATED_VALUE, 0x24 CALCULATED_VALUE}, {0x20 CALCULATED_VALUE, 0x26 CALCULATED_VALUE}, {0x28 CALCULATED_VALUE, 0x2a CALCULATED_VALUE}, {7 CALCULATED_VALUE, 0x2a CALCULATED_VALUE}, {0x2c CALCULATED_VALUE, 0x2a CALCULATED_VALUE}, {0x2e CALCULATED_VALUE, 0x26 CALCULATED_VALUE}, {0x2e CALCULATED_VALUE, 0x24 CALCULATED_VALUE}, {0x30 CALCULATED_VALUE, 0x24 CALCULATED_VALUE}, {0x30 CALCULATED_VALUE, 0x32 CALCULATED_VALUE}, {0x34 CALCULATED_VALUE, 0x36 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 0x36 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x36 CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 0x32 CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 0x24 CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 0x38 CALCULATED_VALUE}, {0x3a CALCULATED_VALUE, 0x3c CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x3c CALCULATED_VALUE}, {7 CALCULATED_VALUE, 0x3c CALCULATED_VALUE}, {0x34 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x34 CALCULATED_VALUE, 0x16 CALCULATED_VALUE}, {0x34 CALCULATED_VALUE, 0x14 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0, 0}, {21600, 0}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 21600}, {0, 21600}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0, 21600}, {0, 0}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0x10 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0, 0}, {21600, 0}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 21600}, {0, 21600}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0, 21600}, {0, 0}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0x10 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0, 0}, {21600, 0}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 21600}, {0, 21600}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0, 21600}, {0, 0}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0x16 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0xc CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0, 0}, {21600, 0}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 21600}, {0, 21600}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0, 21600}, {0, 0}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x14 CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x14 CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0x12 CALCULATED_VALUE, 0x10 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0, 0}, {21600, 0}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 21600}, {0, 21600}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0, 21600}, {0, 0}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0x12 CALCULATED_VALUE}, {0x14 CALCULATED_VALUE, 0x16 CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 0x16 CALCULATED_VALUE}, {7 CALCULATED_VALUE, 0x16 CALCULATED_VALUE}, {0x1a CALCULATED_VALUE, 0x16 CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 0x12 CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {7 CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x1e CALCULATED_VALUE, 0x20 CALCULATED_VALUE}, {0x22 CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x24 CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x24 CALCULATED_VALUE, 0x10 CALCULATED_VALUE}, {0x24 CALCULATED_VALUE, 0x26 CALCULATED_VALUE}, {0x28 CALCULATED_VALUE, 0x2a CALCULATED_VALUE}, {7 CALCULATED_VALUE, 0x2a CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 0x2a CALCULATED_VALUE}, {0x2c CALCULATED_VALUE, 0x2a CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0x26 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0x10 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0, 0}, {21600, 0}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 21600}, {0, 21600}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0, 21600}, {0, 0}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x10 CALCULATED_VALUE, 0x12 CALCULATED_VALUE}, {0x10 CALCULATED_VALUE, 0x14 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0x14 CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x10 CALCULATED_VALUE, 0x12 CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0x12 CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0, 0}, {21600, 0}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 21600}, {0, 21600}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0, 21600}, {0, 0}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x10 CALCULATED_VALUE, 0x12 CALCULATED_VALUE}, {0x10 CALCULATED_VALUE, 0x14 CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0x16 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0x16 CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x1a CALCULATED_VALUE, 8 CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x1a CALCULATED_VALUE, 0x1c CALCULATED_VALUE}, {0x18 CALCULATED_VALUE, 0x16 CALCULATED_VALUE}, {0x1a CALCULATED_VALUE, 0x1e CALCULATED_VALUE}
};
...
{
  {0, 0}, {21600, 0}, {21600, 21600}, {0, 21600}, {0, 0}, {21600, 0}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 0}, {21600, 21600}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {21600, 21600}, {0, 21600}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {3 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0, 21600}, {0, 0}, {1 CALCULATED_VALUE, 2 CALCULATED_VALUE}, {1 CALCULATED_VALUE, 4 CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0xc CALCULATED_VALUE}, {0x10 CALCULATED_VALUE, 0x12 CALCULATED_VALUE}, {0x14 CALCULATED_VALUE, 0x12 CALCULATED_VALUE}, {0x16 CALCULATED_VALUE, 0x18 CALCULATED_VALUE}, {0x16 CALCULATED_VALUE, 0x1a CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 0x1a CALCULATED_VALUE}, {0x1e CALCULATED_VALUE, 0x18 CALCULATED_VALUE}, {0x20 CALCULATED_VALUE, 0x18 CALCULATED_VALUE}, {0x20 CALCULATED_VALUE, 0x22 CALCULATED_VALUE}, {0x1e CALCULATED_VALUE, 0x22 CALCULATED_VALUE}, {0x1c CALCULATED_VALUE, 0x24 CALCULATED_VALUE}, {0x16 CALCULATED_VALUE, 0x24 CALCULATED_VALUE}, {0x16 CALCULATED_VALUE, 0x26 CALCULATED_VALUE}, {0x2a CALCULATED_VALUE, 0x26 CALCULATED_VALUE}, {0x2a CALCULATED_VALUE, 0x28 CALCULATED_VALUE}, {0x10 CALCULATED_VALUE, 0x28 CALCULATED_VALUE}, {0xe CALCULATED_VALUE, 0x2c CALCULATED_VALUE}, {0xa CALCULATED_VALUE, 0x2c CALCULATED_VALUE}
};
